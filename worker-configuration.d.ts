/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: be17d318547d3c2827fd85e2ea983dff)
// Runtime types generated with workerd@1.20251118.0 2025-01-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Sandbox" | "SandboxMcpServer";
	}
	interface Env {
		AUTH_TOKEN: string;
		ANTHROPIC_API_KEY: string;
		SANDBOX: DurableObjectNamespace<import("./src/index").Sandbox>;
		MCP_SERVER: DurableObjectNamespace<import("./src/index").SandboxMcpServer>;
	}
}
